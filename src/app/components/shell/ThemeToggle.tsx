...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      <Sun className="size-4 rotate-90 scale-0 transition-transform dark:rotate-0 dark:scale-100" />
      <Moon className="size-4 absolute rotate-0 scale-100 transition-transform dark:-rotate-90 dark:scale-0" />
    </button>
  );
}
